...
const I18N = {
  en: {
    portfolio:"Porfolio",
    Download_cv:"C.V.",
    hero_pill: "Student Specializing in Ship maintenance and Operation Technology",
    hero_hi: "Hi, I'm",
    hero_name:"Mohamed Moafy",

    hero_subtitle:
      "I work on practical engineering projects in industrial and Marine technologies. This portfolio showcases my technical skills and hands-on experience.",
    hero_btn_projects: "View Projects",
    hero_btn_contact: "Contact Me",
    hero_location: "Port Said, Egypt",
    hero_degree: "East Port Said University of Technology",
    profile_role: "Ship Industrial Technician",
  ...
  ar: {
    ...
    hero_hi: "مرحبًا، أنا",
    hero_name:"محمد موافي",
    hero_subtitle:
      "أعمل على مشاريع هندسية تطبيقية في مجالات الصناعة والتكنولوجيا البحرية. يعرض هذا الموقع مهاراتي التقنية وخبرتي العملية.",
